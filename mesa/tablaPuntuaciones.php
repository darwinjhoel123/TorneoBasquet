...
if(mysqli_num_rows($resulB)>0){	
	$insertar = "INSERT INTO jugador(id_equipo,id_jugador,nombJ,robos,asistencia,faltasJugador,puntuacionTiro) 
	VALUES ('$id_equipo','$id_jugador','$nombJ','$robos','$asistencia','$faltasJugador','$puntuacionTiro')";


	if($resultado = $link->query($insertar)){
		echo "Jugador Registrado CORRECTAMENTE --> ";
		echo "<a href='estadistica.php?id_equipo=$id_equipo'> << REGRESAR </a>";
